...
local function setupmap()
        ...
        --level_map
        levelmap = display.newImage("search3.png")
        levelmap.anchorX=0
        levelmap.anchorY=0
        levelmap.x=194
        levelmap.y=583
...
local function removelast( event )
    ...
    local dataTable = {["Search3"] = undosearch }
...
local function gohome( event )
    ...
    local dataTable = {["Search3"] = homesearch }
...
local function checkresult( event )
    ...
    local runsearchTable = {["Search3"] = runsearch }

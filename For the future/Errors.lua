...
function scene:create( event )
	...
	local background = display.newRect(display.contentCenterX, display.contentCenterY,1920-600,1080-200)
	background:setFillColor(grey,0.5)
	sceneGroup:insert(background)
	local trial=display.newText("Remeber to use method 1 and 2 to get all the commands you need",display.contentCenterX,display.contentCenterY)

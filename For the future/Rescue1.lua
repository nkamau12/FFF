...
function scene:create( event )
	...
	--add walls
	sceneGroup:insert(setupItems["walla"])
	sceneGroup:insert(setupItems["wallb"])
	sceneGroup:insert(setupItems["wallc"])
	sceneGroup:insert(setupItems["walld"])
	sceneGroup:insert(setupItems["wallf"])
	sceneGroup:insert(setupItems["wallj"])
